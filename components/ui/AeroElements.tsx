...
function PixelHeart({ size = 28, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size * 0.85} viewBox="0 0 14 12" className={className} style={{ imageRendering: "pixelated" }}>
...
function PixelFolder({ size = 32, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size * 0.8} viewBox="0 0 20 16" className={className} style={{ imageRendering: "pixelated" }}>
...
function PixelHourglass({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size * 1.2} viewBox="0 0 12 15" className={className} style={{ imageRendering: "pixelated" }}>
...
function GlassOrb({ size, color, top, left, right, bottom, opacity = 0.5, blur = 40, delay = 0 }: {
  size: number; color: string; top?: string; left?: string;
  right?: string; bottom?: string; opacity?: number; blur?: number; delay?: number;
}) {
  return (
    <div
...
function GlossyBubble({ size, top, left, right, bottom, delay = 0 }: {
...
function GlassSheen({ className = "", style = {} }: { className?: string; style?: React.CSSProperties }) {
  return (
    <div
...
function AquaWave({ className = "" }: { className?: string }) {
  return (
    <svg className={`absolute pointer-events-none ${className}`} width="300" height="40" viewBox="0 0 300 40" style={{ opacity: 0.08 }}>
      <path d="M0 20 Q25 5 50 20 Q75 35 100 20 Q125 5 150 20 Q175 35 200 20 Q225 5 250 20 Q275 35 300 20" fill="none" stroke="#0347c1" strokeWidth="2" />
      <path d="M0 28 Q25 13 50 28 Q75 43 100 28 Q125 13 150 28 Q175 43 200 28 Q225 13 250 28 Q275 43 300 28" fill="none" stroke="#80b0ff" strokeWidth="1.5" />
    </svg>
  );
}
...
export function AeroElements() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <GlassOrb size={180} color="#0347c1" top="-40px" right="10%" opacity={0.35} blur={50} delay={0} />
      <GlassOrb size={120} color="#80b0ff" bottom="20%" left="-30px" opacity={0.25} blur={35} delay={2} />
      <GlassOrb size={90} color="#4ade80" top="40%" right="-20px" opacity={0.2} blur={30} delay={1.5} />
      <GlassOrb size={150} color="#c084fc" bottom="-30px" right="30%" opacity={0.15} blur={45} delay={3} />
      ...
      <div className="absolute pointer-events-none" style={{ top: "8%", right: "3%", animation: "pixelBounce 3s ease-in-out infinite", opacity: 0.6 }}>
        <PixelCursor size={28} />
      </div>
      <div className="absolute pointer-events-none" style={{ top: "55%", right: "1%", animation: "pixelBounce 4s ease-in-out infinite 0.5s", opacity: 0.5 }}>
        <PixelHeart size={24} />
      </div>
      <div className="absolute pointer-events-none" style={{ bottom: "25%", left: "1%", animation: "pixelBounce 3.5s ease-in-out infinite 1s", opacity: 0.5 }}>
        <PixelFolder size={28} />
      </div>
      <div className="absolute pointer-events-none" style={{ top: "35%", left: "4%", animation: "pixelBounce 4.5s ease-in-out infinite 1.5s", opacity: 0.45 }}>
        <PixelHourglass size={22} />
      </div>
      <div className="absolute pointer-events-none" style={{ bottom: "8%", right: "6%", animation: "pixelBounce 3.8s ease-in-out infinite 0.8s", opacity: 0.5 }}>
        <PixelCursor size={20} className="scale-x-[-1]" />
      </div>
      <div className="absolute pointer-events-none" style={{ top: "75%", right: "15%", animation: "pixelBounce 3.2s ease-in-out infinite 2s", opacity: 0.4 }}>
        <PixelHeart size={18} />
      </div>

      <GlassSheen className="top-0 right-0 w-[300px] h-[200px]" style={{ background: "radial-gradient(ellipse at top right, rgba(255,255,255,0.08) 0%, transparent 70%)" }} />
      <GlassSheen className="bottom-0 left-0 w-[250px] h-[150px]" style={{ background: "radial-gradient(ellipse at bottom left, rgba(3,71,193,0.06) 0%, transparent 70%)" }} />
    </div>
  );
}
